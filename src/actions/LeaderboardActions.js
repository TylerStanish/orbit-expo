...
export const fetchLeaderboard30 = () => {
	return dispatch => {
		...
		leaderboard30Query = firebase.firestore().collection('leaderboard30').orderBy('score').limit(10);
...
export const fetchLeaderboard60 = () => {
	return dispatch => {
		...
		leaderboard60Query = firebase.firestore().collection('leaderboard60');
...
export const fetchLeaderboard90 = () => {
	return dispatch => {
		...
		leaderboard90Query = firebase.firestore().collection('leaderboard90');
